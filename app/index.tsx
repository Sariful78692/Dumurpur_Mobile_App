...
const renderActionIcon = (title: string) => {
  switch (title) {
    ...
    case 'Gazal Book':
      return <MaterialCommunityIcons name="music-note-outline" size={54} color="#00bcd4" />;
    case 'Namaz Shiksha':
...
const styles = StyleSheet.create({
  ...
  scrollContent: { paddingVertical: 18, paddingBottom: 92, marginTop: 8 },
  headerCard: { backgroundColor: 'rgba(14, 77, 36, 0.9)', borderRadius: 22, padding: 16, alignItems: 'center', elevation: 5 },
  title: { fontSize: 22, fontWeight: '700', color: '#f9bf3a', textAlign: 'center', marginBottom: 6 },
  subtitle: { color: '#eaf7ee', fontSize: 13, letterSpacing: 0.5, marginBottom: 14 },
  heroImage: { width: '100%', height: 180, borderRadius: 16, borderWidth: 2, borderColor: '#f9bf3a' },
  grid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: 24, gap: 10 },
  card: { minHeight: 104, backgroundColor: 'rgba(18, 94, 43, 0.93)', borderRadius: 18, paddingVertical: 9, paddingHorizontal: 8, alignItems: 'center', justifyContent: 'space-between', borderWidth: 2, borderColor: '#f9bf3a', elevation: 4 },
  cardIcon: { width: 44, height: 44 },
  cardText: { backgroundColor: '#f9bf3a', color: '#123b1d', width: '90%', textAlign: 'center', borderRadius: 10, paddingVertical: 5, fontWeight: '700', fontSize: 12, overflow: 'hidden' },
  footerContainer: { marginTop: 26, alignItems: 'center', justifyContent: 'center' },
  footerText: { color: '#fff8e1', fontWeight: '700', backgroundColor: 'rgba(0,0,0,0.25)', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 999 },
});